...
export const GameList = ({ games, setGames, filteredGames, setFilteredGames, user, currentUser }) => {
    useEffect(() => {
    ...
    return (
        ...
        >
            {filteredGames.map(game => {
                return <Game game={game} user={user} currentUser={currentUser} key={game.id} />
            })}
        </Box>
    )
}